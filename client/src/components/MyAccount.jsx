...
// console.log('llllllllll')
  ...
  return (
    <div className="b mt-[10vh]">
      ...
      <div className="ml-2 mb-10 mt-10">
        <form className="grid" method="/signup" action="POST" onSubmit={submit}>
          ...
          <button
            type="submit"
            className="mr-auto ml-2 bg-black text-white p-2 px-5"
          >
            Add
          </button>
        </form>
      ...
      <div className="ml-2">
        ...
        {arr.length != 0 ? (
          <div>
            ...
            {arr.map((e) => (
              <div className="my-4">
               ...
               <div className="flex ">
                <div>
                <p className="text-xl">Account No. : {e.account_num}</p>
                <p className="text-xl">IFSC Code : {e.ifsc_code}</p>
                <p className="text-xl">Pin : {e.pin}</p>
                <p className="text-xl">Website Link : {e.web_link}</p>
                </div>
                <div className="ml-auto mr-5">
                <i onClick={()=>{del(e._id)}} className="fa-solid fa-trash text-4xl cursor-pointer"></i>
                </div>
               </div>
          ...
          <p className="text-2xl font-semibold text-gray-500">No account detail yet </p>
        )}
      </div>
    </div>
  );
